...
<body>
	<div class="container">
		...
		<div class="stats-grid">
			...
			<div class="stat-card ${engineName.includes('Python') ? 'python' : engineName.includes('Rust') ? 'rust' : 'node'}">
				<div class="stat-title">⚡ IO 引擎</div>
				<div class="stat-value" style="font-size: 1.8em;">${engineName.split('(')[0].trim()}</div>
