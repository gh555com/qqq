...
<p align="left">
 ...
 qqq is very lightweight: Built on a highly efficient Rust-based underlying architecture with extreme performance optimization, qqq's idle CPU and disk IO overhead approach absolute zero. Its ultra-low memory footprint is also remarkably prominent, especially in scenarios where multiple IDEs (Cursor, Antigravity, etc.) are running simultaneously with a large number of open windows.

  For architectural details: https://github.com/gh555com/qqq/blob/qq/docs/IO_ENGINE_v16.md
